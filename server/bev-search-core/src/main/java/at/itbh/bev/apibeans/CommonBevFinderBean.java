...
@Stateless
public class CommonBevFinderBean implements CommonBevFinder {
	...
	public GeocodingResult<AustrianCommonQueryResult> geocode(String postalCode, String place, String addressLine, String houseId)
		...
		try {
			return finder.queryIndex(AustrianCommonQueryResult.class, fullTextQuery, maxResults, prune, postalCode, place, addressLine, houseId, null, null,
					null);
		} catch (Exception e) {
	...
	@Override
	public GeocodingResult<AustrianCommonQueryResult> reverseGeocode(Double latitude, Double longitude, Float radius)
			throws InvalidApiUsageException {
		...
		try {
			return finder.queryIndex(AustrianCommonQueryResult.class, fullTextQuery, maxResults, prune, null, null, null, null, latitude, longitude, radius);
		} catch (Exception e) {
			throw new EJBException(e);
		}
	}
	...
	@Override
	public List<AustrianCommonAddress> findAddressByADRCD(String adrcd) {
		throw new UnsupportedOperationException();
	}

	@Override
	public AustrianCommonAddress findAddress(String adrcd, String subcd) throws TooManyResultsException {
		throw new UnsupportedOperationException();
	}

	@Override
	public AustrianCommonAddress findAddress(String id) {
		throw new UnsupportedOperationException();
	}
	...
	public GeocodingResult<AustrianCommonQueryResult> geocode(String postalCode, String place, String addressLine, String houseId,
		...
		try {
			return finder.queryIndex(AustrianCommonQueryResult.class, fullTextQuery, maxResults, prune, postalCode, place, addressLine, houseId, latitude, longitude, radius);
		} catch (Exception e) {
			throw new EJBException(e);
		}
	}
